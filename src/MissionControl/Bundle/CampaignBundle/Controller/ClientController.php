...
use MissionControl\Bundle\CampaignBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CampaignBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("CampaignBundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CampaignBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CampaignBundle:Client:edit.html.twig")
     */
