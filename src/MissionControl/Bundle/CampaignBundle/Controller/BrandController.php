...
use MissionControl\Bundle\CampaignBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CampaignBundle:Brand')->findAll();
     ...
     * @Method("POST")
     * @Template("CampaignBundle:Brand:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CampaignBundle:Brand')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CampaignBundle:Brand:edit.html.twig")
     */
